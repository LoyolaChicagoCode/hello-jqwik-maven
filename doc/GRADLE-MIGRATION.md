...
```
build/libs/hello-jqwik-1.0-SNAPSHOT-all.jar
```

This JAR can be executed standalone:
```bash
java -jar build/libs/hello-jqwik-1.0-SNAPSHOT-all.jar [args...]
```
...
7. **jqwik Integration**: Native support for property-based testing
